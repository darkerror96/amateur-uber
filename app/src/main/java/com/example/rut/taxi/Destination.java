...
public class Destination extends AppCompatActivity implements OnMapReadyCallback, View.OnClickListener, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerDragListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap=googleMap;
        gps = new com.example.rut.taxi.GPSTracker(Destination.this);
    ...
    public void onClick(View view) {
        ...
        if (lat > 0.0 & lon > 0.0)
        {
            loc.child(userId).child("Destination").child("Latitude").setValue(lat);
            loc.child(userId).child("Destination").child("Longitude").setValue(lon);
        ...
        {
            Toast.makeText(getApplicationContext(),"Destination Location is loading...Please wait...", Toast.LENGTH_LONG).show();
        }
